...
def send_notification(arguments=None, geodata=None, useremail=None, user_address=None):
	...
	try:
		subject = SUBJECT_TEXT.format(p=arguments, g=geodata, u=useremail, uip=user_address)
		body = BODY_TEXT.format(p=arguments, g=geodata, u=useremail, uip=user_address)
